...
def get_parser():
    parser = argparse.ArgumentParser(
        description='Relational Architecure')
    ...
    parser.add_argument('--train_model', default='RelArch', help='Your model name')
    parser.add_argument('--load_model', default=None, type=str, help="load pretrained model for test or training")
    parser.add_argument('--model', default='tp_model.tp_model')
